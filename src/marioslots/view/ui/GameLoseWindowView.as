package marioslots.view.ui
{
	...
	public class GameLoseWindowView extends AbstractWindowView
	{
		public function GameLoseWindowView()
		{
		}
		...
		public function setBonusInfo(lvlCollect:int):void
		{
			_dialogText.text = "You LOSE!\rCollect on level:"+lvlCollect;	
		}
